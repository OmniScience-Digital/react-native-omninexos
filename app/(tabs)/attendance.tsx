...
// // lucide-react-native v1.x TS defs missing color prop
...
//   record,
// }: {
//   record: NonNullable<ReturnType<typeof useClockIn>["activeRecord"]>;
// }) {
//   const { theme } = useTheme();
...
//   history,
// }: {
//   history: ReturnType<typeof useClockIn>["history"];
// }) {
//   const { theme } = useTheme();
...
//                   weight="600"
//                 >
//                   {referencePhotoUri ? "Change Photo" : "Set Up Now"}
//                 </ThemedText>
//               </Pressable>
//             </View>
//           </View>
